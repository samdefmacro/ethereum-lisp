...
recipient, data, access-list, blob, and set-code authorization field shapes for
the whole batch before applying the first transaction. Historical Ethash block beneficiary and ommer rewards now have a
