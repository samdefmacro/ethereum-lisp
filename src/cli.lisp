...
(defparameter *devnet-cli-optional-boolean-options*
  '("--http" "--ws" "--graphql" "--nodiscover" "--ipcdisable"
    ...
    "--log.compress" "--dev" "--nousb" "--json" "--no-serve"))
