...
(defun engine-rpc-handle-public-filter-method (context)
  (let ((params (public-rpc-dispatch-context-params context))
        ...
        (now (public-rpc-dispatch-context-txpool-now context)))
    (cond
