...
(defun engine-rpc-handle-public-metadata-method (context)
  (let ((params (public-rpc-dispatch-context-params context))
    ...
    (cond
      ...
      ((public-rpc-dispatch-method-p context "eth_capabilities")
       (public-rpc-dispatch-response
        context
        (engine-rpc-handle-eth-capabilities params store)))
      ...
      ((public-rpc-dispatch-method-p context "eth_gasPrice")
       (public-rpc-dispatch-response
        context
        (engine-rpc-handle-eth-gas-price
         params store config
         (public-rpc-dispatch-context-gas-oracle-state context))))
