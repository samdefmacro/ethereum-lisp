...
(defun memory-chain-store-put-block
  ...
  (let ((stored-block (engine-payload-store-copy-block block))
    ...
    ;; Candidate executability is not canonical publication. In particular, a
    ;; SNAP tail executes under P2P import after an earlier FCU returned SYNCING.
    ;; Keep that consensus target pending until PUBLISH-CANONICAL-BLOCK consumes
